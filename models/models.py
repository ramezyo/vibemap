...
class AgentCheckin(Base):
    ...
    # "agent_inferred"  — agent deduced from public data (Reddit, news, APIs)
    # "sensor_feed"     — IoT / smart city sensor data
    # "synthetic"       — generated by simulation/testing, not real
    observation_source = Column(String(50), default="agent_inferred", nullable=False)
    observation_confidence = Column(Float, default=0.5)  # 0.0–1.0
    
    # Extracted observation text for full-text search
    # Populated from sensory_payload.observation at write time
    observation_text = Column(Text, default="")
